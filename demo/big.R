...
# MHCA
# feature space plot
plot(x[,1],x[,2],asp=1,col=apriori,main=paste0('Mahalanobis HCA (MHCA) (n=',n1*m,')'))
# dendrogram
...
# MHCA with apriori clusters
# feature space plot
plot(x[,1],x[,2],asp=1,col=apriori,main=paste0('MHCA with apriori clusters (n=',n1*m,')'))
# dendrogram
