...
if (exists('saveMe')&&saveMe) png('subthresh4.png',1400,1000)
opar<-par(mfcol=c(3,8),mar=c(3,2,2,1)+0.1)

set.seed(1)
xy2<-rbind(
    cbind(rnorm(100),rnorm(100)),
    cbind(rnorm(40,0,.1),rnorm(40,4.5,.1)),
    cbind(rnorm(100,0,.1/5),rnorm(100,10)))
...
addMark<-function(m) {
    mtext(paste0('4',m),line=.3,adj=0,font=2,cex=1.5)
}
